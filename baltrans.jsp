...
<div class="">
<h2 class="section-header">Balance Transfer<span>.</span></h2>
</div>
...
<%
	try{
		...
		case Contents.WP_ST_SUCCESS:
			out.println("<center><font color=\"green\">Balance transfer successfully !</font></center>");
			break;
		case Contents.WP_ST_ERROR:
			out.println("<center><font color=\"red\">Balance transfer fail !</font></center>");
			break;
	...
	<%
			...
			<form action="transferbal" method="POST">
	...
	<tr>
		<td style="padding:5px;">BALANCE</td><td>:</td>
		<td width="350" style="padding:5px;">
			<input type="text" name="balance" placeholder="Name" value="<%=rs.getString("BALANCE")%>" readonly="readonly" maxlength="20" required="" class="form-control" />
		</td>
	</tr>
	<tr>
		<td style="padding:5px;">Account No To</td><td>:</td>
		<td width="350" style="padding:5px;">
			<input type="text" name="toaccno" placeholder="To Account No" maxlength="20" required="" class="form-control" />
		</td>
	</tr>
	<tr>
		<td style="padding:5px;">Confirm Account No To</td><td>:</td>
		<td width="350" style="padding:5px;">
			<input type="text" name="ctoaccno" placeholder="Confirm To Account No" maxlength="20" required="" class="form-control" />
		</td>
	</tr>
	<tr>
		<td style="padding:5px;">Amount</td><td>:</td>
		<td width="350" style="padding:5px;">
			<input type="text" name="amount" placeholder="Balance" value="00.00" required="" class="form-control" />
		</td>
	</tr>
	...
	<tr>
		<td colspan="3" align="right" style="padding:5px;">
			<button type="submit" class="btn submit" style="width: 100%;">Transfer Balance</button>
		</td>
	</tr>
