...
if(!Contents.isLogin(request,Contents.WP_TYPE_ADMIN)){
	...
	response.setHeader("Location", "banklogin.jsp");
}
%>
<!DOCTYPE html>
<html lang="en">
...
<div class="">
<h2 class="section-header">Bank Workbench<span>.</span></h2>
</div>
...
<section class="about-text-area" style="margin-top: -40px;">
<div class="container">
<div class="row">
<%
	Connection con=DAO.getConnection();
	Statement st=(Statement)con.createStatement();
	ResultSet rs=st.executeQuery("SELECT * FROM acc_details ORDER BY ID DESC LIMIT 0,1");
	int last_acc_no=000000000000;
	if(rs.next()){
		last_acc_no=Integer.parseInt(rs.getString("ACCNO"));
	}
	last_acc_no++;
	String acc_no=Contents.formatAccountNo(String.valueOf(last_acc_no));
%>
<h2>Create Account</h2><br/><br/>
	...
	try{
		...
		case Contents.WP_ST_SUCCESS:
			out.println("<center><font color=\"green\">Account created !</font></center>");
			break;
		case Contents.WP_ST_ERROR:
			out.println("<center><font color=\"red\">Account creation fail !</font></center>");
			break;
	...
	<tr>
		...
		<td width="350" style="padding:5px;">
			<input type="text" name="accno" placeholder="Account No" value="<%=acc_no %>" readonly="readonly" maxlength="12" required="" class="form-control" />
		</td>
	</tr>
	<tr>
		<td style="padding:5px;">Name</td><td>:</td>
		<td width="350" style="padding:5px;">
			<input type="text" name="name" placeholder="Name" maxlength="20" required="" class="form-control" />
		</td>
	</tr>
	<tr>
		<td style="padding:5px;">UserID</td><td>:</td>
		<td width="350" style="padding:5px;">
			<input type="text" name="userid" placeholder="User id" maxlength="20" required="" class="form-control" />
		</td>
	</tr>
	<tr>
		<td style="padding:5px;">Password</td><td>:</td>
		<td style="padding:5px;">
			<input type="password" name="pass" placeholder="Password" maxlength="20" required="" class="form-control" />
		</td>
	</tr>
	<tr>
		<td style="padding:5px;">Re-password</td><td>:</td>
		<td width="350" style="padding:5px;">
			<input type="password" name="repass" placeholder="Re-password" maxlength="20" required="" class="form-control" />
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td width="350" style="padding:5px;">
			<textarea name="addr" rows="7" cols="31" class="form-control"></textarea>
		</td>
	</tr>
	<tr>
		<td style="padding:5px;">Approval</td><td>:</td>
		<td width="350" style="padding:5px;">
