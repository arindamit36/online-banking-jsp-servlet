...
<p>Welcome, <%=session.getAttribute(Contents.WP_NAME) %>.<br/>We’ve all heard how crucial it is to set intentions, goals and targets. Powerful goals electrify us. Clear intentions energize and pull us forward.</p>
</div>
</div>
</section>
...
<div class="row">
	<div class="col-md-6 col-sm-6 col-xs-6">
		<button type="button" onclick="document.location='create_account.jsp'" class="btn submit" style="width:100%;">Create User Account</button>
	</div>
	<div class="col-md-6 col-sm-6 col-xs-6">
		<button type="button" onclick="document.location='view_account.jsp'" class="btn submit" style="width:100%;">View Account</button>
	</div>
</div>
<div class="row" style="margin-top:20px;">
	<div class="col-md-6 col-sm-6 col-xs-6">
		<button type="button" onclick="document.location='bank_withdraw.jsp'" class="btn submit" style="width:100%;">Withdraw Balance</button>
	</div>
	<div class="col-md-6 col-sm-6 col-xs-6">
		<button type="button" onclick="document.location='bank_deposit.jsp'" class="btn submit" style="width:100%;">Deposit Balance</button>
	</div>
</div>
<div class="row" style="margin-top:20px;">
	
	<div class="col-md-6 col-sm-6 col-xs-6">
		<button type="button" class="btn submit" onclick="document.location='update_bankers_profiles.jsp'" style="width:100%;">Update Banker Profile</button>
	</div>
	<div class="col-md-6 col-sm-6 col-xs-6">
		<button type="button" onclick="document.location='create_bank_user.jsp'" class="btn submit" style="width:100%;">Add Employees</button>
	</div>
