...
<div class="container">
<div class="row">
<h2>Bank Withdraw Balance</h2><br/><br/>
	<%
	try{
		switch(Integer.parseInt(request.getParameter("status"))){
		case Contents.WP_ST_SUCCESS:
			out.println("<center><font color=\"green\">Balance withdrawn successfully !</font></center>");
			break;
		case Contents.WP_ST_ERROR:
			out.println("<center><font color=\"red\">Balance withdrawn fail !</font></center>");
			break;
	...
	%>
	<form name="withdraw" action="bankwithdraw" method="POST">
	<div id="server-data">
	<table align="center">
	<tr>
		<td style="padding:5px;">Account No</td><td>:</td>
		<td width="350" style="padding:5px;">
			<input type="text" name="accno" id="accno" placeholder="Account No" value="" maxlength="12" required="" class="form-control" />
		</td>
	</tr>
	</table>
	</div>
...
$(document).ready(function(){
	$("#accno").change(function(){
		...
		$("#server-data").load("http://localhost:48/Internet_Banking/apis?key=10112&request=GetAccDetails&accno="+accno);
