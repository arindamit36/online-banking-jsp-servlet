...
<div class="container">
<div class="row">
<h2>Bank Deposit Balance</h2><br/><br/>
	<%
	try{
		switch(Integer.parseInt(request.getParameter("status"))){
		case Contents.WP_ST_SUCCESS:
			out.println("<center><font color=\"green\">Balance Deposit successfully !</font></center>");
			break;
		case Contents.WP_ST_ERROR:
			out.println("<center><font color=\"red\">Balance Deposit fail !</font></center>");
			break;
	...
	%>
	<form name="deposit" action="bankdeposit" method="POST">
	<div id="server-data">
	<table align="center">
	<tr>
